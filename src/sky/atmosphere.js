...
`;
export const ATMOS_VS_WGSL = /* wgsl */`
...
`;
export const TRANSMITTANCE_FS_WGSL = /* wgsl */`
${WGSL_COMMON}
varying uv0: vec2f;
...
export const MULTISCATTER_FS = /* glsl */`
${GLSL_COMMON}
...
`;
export const MULTISCATTER_FS_WGSL = /* wgsl */`
${WGSL_COMMON}
...
`;
export const SKY_FS = GLSL_COMMON + GLSL_SKY_BODY;
...
`;
export const SKY_FS_WGSL = WGSL_COMMON + WGSL_SKY_BODY;
 ...
 */
export function sunTransmittanceCPU(sunDir, p) {
